            		...
            		<div class="form-wrapper">
            			<form>
            				<div class="form-group">
            					<label class="sr-only">Nomor Kendaraan</label>
            				...
            				<div class="form-group">
            					...
            					<input type="text" class="form-control" id="jenis_kelamin" placeholder="Merek">
            				</div>

            				<div class="form-group">
            					<label class="sr-only">Tahun</label>
            					<input type="text" class="form-control" id="alamat" placeholder="Tahun">
            				</div>

            				<div class="form-group">
            					<label class="sr-only">Nomor Uji</label>
            					<input type="text" class="form-control" id="agama" placeholder="Nomor Uji">
            				</div>
