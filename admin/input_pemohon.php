    ...
    <div class="container-fluid display-table">
      <div class="row display-table-row">
          ...
          <div class="col-md-10 col-sm-11 display-table-cell valign-top">
            ...
            <div id="content">
             <form  id="formKu" class="form-horizontal" role="form" >
            	<header>
            		<h2 class="page_title">Form Input Pemohon</h2>
            	</header>
            	...
            	<div class="content-inner">
            		<div class="form-wrapper">
                      ...
                      <div class="col-sm-10">
            					<input type="text" class="form-control" id="nama" placeholder="Nama" style="width: 200px;">
                      </div>
            				</div>
