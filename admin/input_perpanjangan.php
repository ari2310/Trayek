          ...
          <div class="col-md-10 col-sm-11 display-table-cell valign-top">
            ...
            <div id="content">
             <form  id="formKu" class="form-horizontal" >
            	<header>
            		<h2 class="page_title">Form Input Kendaraan</h2>
            	</header>
            	...
            	<div class="content-inner">
            		<div class="form-wrapper">
            			<form>
            				<div class="form-group">
            					<label class="sr-only">Tanda Nomor</label>
            					<input type="text" class="form-control" id="nama" placeholder="Nomor Kendaraan">
            				</div>

            				<div class="form-group">
            					<label class="sr-only">Nama Pemilik</label>
            					<input type="text" class="form-control" id="tmp_lahir" placeholder="Nama Pemilik">
            				</div>

            				<div class="form-group">
            					<label class="sr-only">Pimpinan PO</label>
            					<input type="text" class="form-control" id="jenis_kelamin" placeholder="Pimpinan PO">
            				</div>

            				<div class="form-group">
            					<label class="sr-only">Merek</label>
            					<input type="text" class="form-control" id="alamat" placeholder="Merek">
            				</div>

            				<div class="form-group">
            					<label class="sr-only">Tahun</label>
            					<input type="text" class="form-control" id="agama" placeholder="Tahun">
            				</div>

                    <div class="form-group">
                      <div class="input-group date" id="tgl_lahir">
                        <label class="sr-only">Tanggal Berlaku</label>
                        <input type="text" name="tgl_lahir" class="form-control" placeholder="Tanggal Berlaku"/>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Status" placeholder="Kode Trayek">
                    </div>

                     <div class="form-group">
                      <label class="sr-only">Lintasan</label>
                      <input type="text" class="form-control" id="Status" placeholder="Lintasan">
                    </div>

                     <div class="form-group">
                      <label class="sr-only">Orang</label>
                      <input type="text" class="form-control" id="Status" placeholder="Orang">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Status" placeholder="Barang">
                    </div>
